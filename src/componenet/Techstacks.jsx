...
const TechStacks = () => {
  ...
  return (
    <div name="TechStacks" className="bg-black from-gray-900 to-black w-full ">
      <div className="max-w-screen-lg mx-auto p-4 flex flex-col justify-center w-full min-h-screen text-white">
        <div className="py-6">
          <p className="text-4xl font-bold  border-b-4 border-green-600 inline">
            TechStacks
          </p>
        ...
        <div className="w-full grid grid-cols-2 sm:grid-cols-3 gap-8 text-center py-8 px-8 sm:px-0">
          {techs.map(({ id, src, title, style }) => (
            <div
              key={id}
              className={`shadow-md sm:w-full hover:scale-105 duration-500 py-2 rounded-lg ${style} `}
            >
